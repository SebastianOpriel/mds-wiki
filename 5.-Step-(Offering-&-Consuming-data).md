...
<br>
The lists of defined MDS Data catgories, subcategories and transport modes are available [hier](https://github.com/Mobility-Data-Space/mobility-data-space/wiki/MDS-Ontologie).
...
When describing a resource (Offered Resource-API), you can also enter attributes manually:
"language": "ENGLISH", <br>
