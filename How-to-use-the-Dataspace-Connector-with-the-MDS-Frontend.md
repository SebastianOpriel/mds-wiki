...
For the access to the MDS test stage please take the following steps
(for the pilot stage follow same steps + set your unique DAPS Token and the URL of the MDS Catalog)
