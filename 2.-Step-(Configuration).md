...
3. Adjust `config.json`
   ...
   * Set `@value` of `ids:description` element to your desired connector description (e.g., `An MDS Dataspace Connector of DRM Datenraum Mobilität GmbH for demonstration purposes`)
...
2. Adjust Dataspace Connector's settings
   * Adjust `src/main/resources/conf/config.json`
       ...
       * Set `@value` of `ids:title` element to your desired connector name (e.g., `"@id" : "DRM Datenraum Mobilität GmbH Dataspace Connector"`
       * Set `@value` of `ids:description` element to your desired connector description (e.g., `An MDS Dataspace Connector of DRM Datenraum Mobilität GmbH for demonstration purposes`)
