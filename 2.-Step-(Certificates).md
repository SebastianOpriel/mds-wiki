...
Certificate will no longer we send by email but alternatively via a shared fileshare, that require your registration in the first step and will be secured by a 2 FA (factor authentication).
